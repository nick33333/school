...
parser.add_argument('-o','--output_file', default = "New_Week5.png")
...
panel1.set_yticks(np.linspace(0,2,3))
...
panel2.tick_params(bottom=True,labelbottom=True,
                  ...
                  right=False, labelright=False,
                  top=False, labeltop=False)
panel1.set_title("5'SS", fontsize=14)
panel1.set_xlabel("Distance to\nSplice Site", fontsize=12)
panel1.set_ylabel("Bits", fontsize=12)

panel2.set_title("3'SS", fontsize=14)
