...
parser.add_argument('-o','--output_file',default='New_Week3_Plot.png')
...
panel1.set_xlabel(r"log$_{2}$(fold change)", fontsize=12)
panel1.set_ylabel(r"-log$_{10}$(p-value)", fontsize=12)
panel1.set_xticks(np.linspace(-10,10,3))
panel1.set_yticks(np.linspace(0,60,4))
panel1.xaxis.set_tick_params(width=1.1)
panel1.yaxis.set_tick_params(width=1.1)
panel1.tick_params(labelsize=12)
# panel1.tick_params(pad=5)
